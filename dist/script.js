...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var sliderMain = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    wrapper: ".page",
    btns: '.next'
  });
  sliderMain.launchSlider();
  var sliderMainModules = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    wrapper: ".moduleapp",
    btns: '.next',
    btnsPrev: '.prev'
  });
  sliderMainModules.launchSlider();
  var sliderShowUp = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var sliderModules = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  var sliderFeed = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('form', './assets/question.php').run();
});
    ...
    value: function run() {
      ...
      this.form.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMassage.textContent = _this.massage.sending;
          creaateImgTag.setAttribute('src', _this.massage.sendingImg);
          ...
          fetch(_this.path, {
            ...
            console.log(data);
            statusMassage.textContent = _this.massage.successfully;
            creaateImgTag.setAttribute('src', _this.massage.successfullyImg);
          }).catch(function () {
            statusMassage.textContent = _this.massage.unsuccessful;
            creaateImgTag.setAttribute('src', _this.massage.unsuccessfulImg);
          }).finally(function () {
            closeStatusMessage();
            item.reset();
          });
...
/*#__PURE__*/
function () {
  function PlayVideo(playBtn, overlay) {
  ...
  _createClass(PlayVideo, [{
    key: "createPlayer",
    value: function createPlayer(ytId) {
    ...
    value: function open() {
      ...
      this.playBtn.forEach(function (item) {
        item.addEventListener('click', function () {
          var ytId = item.getAttribute('data-url');
          _this.overlayBlock.style.display = 'flex';

          if (!document.querySelector('iframe#frame')) {
            _this.createPlayer(ytId);
          }
        });
      });
    }
    ...
    value: function close() {
      ...
      this.closeBtn.addEventListener('click', function () {
        _this2.overlayBlock.style.display = 'none';

        _this2.player.stopVideo();
      });
      this.overlayBlock.addEventListener('click', function () {
        _this2.overlayBlock.style.display = 'none';

        _this2.player.stopVideo();
      });
      window.addEventListener('keydown', function (e) {
        if (e.code === 'Escape' && _this2.overlayBlock.style.display === 'flex') {
          _this2.player.stopVideo();
...
function (_Slider) {
  ...
  function MainSlider(wrapper, btns, btnsPrev) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, wrapper, btns, btnsPrev));
  }

  _createClass(MainSlider, [{
    key: "showCurentIndex",
    value: function showCurentIndex() {
      try {
    ...
    key: "showSliderUp",
    value: function showSliderUp() {
      this.sliderIndex++;
    }
  }, {
    key: "showSliderDown",
    value: function showSliderDown() {
      this.sliderIndex--;
    }
  }, {
    key: "hideSlide",
    ...
    key: "showTeacherBlock",
    value: function showTeacherBlock() {
      var _this = this;
      ...
      try {
        ...
        if (this.item[2].style.display === 'block') {
          setTimeout(function () {
            _this.teacherBlock.style.display = 'block';
          }, 3000);
        }
      } catch (error) {}
    }
    ...
    value: function launchSlider() {
      ...
      this.btns.forEach(function (elem) {
        elem.addEventListener('click', function (e) {
          ...
          _this2.showCurentIndex();

          _this2.hideSlide();

          _this2.showTeacherBlock();
        });
      });
      this.btnsPrev.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();

          _this2.showSliderDown();
...
function (_Slider) {
  ...
  function MiniSlider(wrapper, prev, next, activeClass) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, wrapper, prev, next, activeClass));
  }
    ...
    value: function btnAction() {
      ...
      try {
        this.next.addEventListener('click', function () {
          _this.wrapper.append(_this.item[0]);

          _this.activeItem();
        });
        this.prev.addEventListener('click', function () {
          _this.wrapper.prepend(_this.item[_this.item.length - 1]);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$btnsPrev = _ref.btnsPrev,
      btnsPrev = _ref$btnsPrev === void 0 ? null : _ref$btnsPrev,
      _ref$prev = _ref.prev,
      ...
      autoplay = _ref$autoplay === void 0 ? null : _ref$autoplay;
